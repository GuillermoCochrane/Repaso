...
console.log("");
let fecha = new Date();
let indiceMes = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
let indiceSemana = ["domingo", "lunes", "martes", "miercoles", "jueves", "viernes", "sabado"];


console.log('Hoy es el día '+ indiceSemana[fecha.getDay()] + " " + fecha.getDate() +' de '+ indiceMes[fecha.getMonth()] +' del año '+fecha.getFullYear());
