...
class Topbar extends Component {
	...
	hideSidebar = () => {
        document.querySelector('#accordionSidebar').classList.toggle('hide');
		console.log('clicked')
    }
	...
	render() {	
		return (
			<nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
						...
						<button id="sidebarToggleTop" className="btn btn-link rounded-circle mr-3" onClick={()=>this.hideSidebar()}>	
